...
def Detail_create(request, person_id):    #this view displays the various sections of the survey and redirects to the Create view 
...
def Create(request, person_id, start, finish, status):      #This is the view in which all answer objects are created
...
def Detail_update(request, person_id):     # Displays the various sections of the survey that can be edited/updated
...
def Update(request, person_id, start, finish, status):   # Updates the answer objects
